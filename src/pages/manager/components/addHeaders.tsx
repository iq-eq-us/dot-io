...
export function addHeadersToDataTable() {
  ...
  const header: HTMLTableSectionElement =
    dataTable.createTHead() as HTMLTableSectionElement;
  const row: HTMLTableRowElement = dataTable.insertRow(
    0,
  ) as HTMLTableRowElement; //insert row at top
  const cells = [];
