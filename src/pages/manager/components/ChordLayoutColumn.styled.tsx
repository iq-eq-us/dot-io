...
export const CardCancelButton = styled.button.attrs(
  (props: { cancelled: boolean }) => ({
    className: `text-xs m-2 mt-6 float-right font-semibold rounded-full px-4 py-1 shadow-sm shadow-black leading-normal bg-[#FFFFF] text-purple hover:bg-purple hover:text-black ${
      props.cancelled ? 'hidden' : ''
    }`,
  }),
)``;
