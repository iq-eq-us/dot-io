...
export function ImportChords(): ReactElement {
  ...
  async function importChordMapLibrary(e: any) {
    ...
    fileReader.onload = (readerEvent) => {
      ...
      lines.forEach(async (line) => {
        ...
        const hexPhraseString =
          convertHumanStringToHexadecimalPhrase(humanPhrase);
        ...
        const tempCreated: ChordStructure = createChord(
          strValues[0],
          strValues[1],
          strValues[3],
          strValues[4],
  ...
  function click() {
    ...
    const elementChords: HTMLInputElement = document.getElementById(
      'file-input',
