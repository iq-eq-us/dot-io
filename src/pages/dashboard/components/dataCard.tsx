...
export default class CardData extends React.Component {
  ...
  render() {
    return (
      ...
      <tr style={sd}>
        <td rowSpan={2}/>
        <th colSpan={2} scope="colgroup">tWPM<div>{getHighestWPM()}</div></th>
      ...
      <tr style={this.state.seenGoalTable? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[11]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[11]}</td>
        <td style={tableText}>{calculateActualValue(83,11,12)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[11]}</td>
        <td style={tableText}>{calculateActualValueAWPM(83,11,12)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[11]}</td>
        <td style={tableText}>{calculateActualValueChM(83,11,12)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[11]}</td>
        <td style={tableText}>{calculateActualValueCPM(83,11,12)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[10]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[10]}</td>
        <td style={tableText}>{calculateActualValue(76,10,11)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[10]}</td>
        <td style={tableText}>{calculateActualValueAWPM(76,10,11)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[10]}</td>
        <td style={tableText}>{calculateActualValueChM(76,10,11)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[10]}</td>
        <td style={tableText}>{calculateActualValueCPM(76,10,11)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[9]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[9]}</td>
        <td style={tableText}>{calculateActualValue(69,9,10)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[9]}</td>
        <td style={tableText}>{calculateActualValueAWPM(69,9,10)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[9]}</td>
        <td style={tableText}>{calculateActualValueChM(69,9,10)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[9]}</td>
        <td style={tableText}>{calculateActualValueCPM(69,9,10)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[8]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[8]}</td>
        <td style={tableText}>{calculateActualValue(62,8,9)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[8]}</td>
        <td style={tableText}>{calculateActualValueAWPM(62,8,9)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[8]}</td>
        <td style={tableText}>{calculateActualValueChM(62,8,9)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[8]}</td>
        <td style={tableText}>{calculateActualValueCPM(62,8,9)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[7]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[7]}</td>
        <td style={tableText}>{calculateActualValue(55,7,8)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[7]}</td>
        <td style={tableText}>{calculateActualValueAWPM(55,7,8)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[7]}</td>
        <td style={tableText}>{calculateActualValueChM(55,7,8)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[7]}</td>
        <td style={tableText}>{calculateActualValueCPM(55,7,8)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[6]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[6]}</td>
        <td style={tableText}>{calculateActualValue(48,6,7)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[6]}</td>
        <td style={tableText}>{calculateActualValueAWPM(48,6,7)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[6]}</td>
        <td style={tableText}>{calculateActualValueChM(48,6,7)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[6]}</td>
        <td style={tableText}>{calculateActualValueCPM(48,6,7)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[5]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[5]}</td>
        <td style={tableText}>{calculateActualValue(41,5,6)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[5]}</td>
        <td style={tableText}>{calculateActualValueAWPM(41,5,6)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[5]}</td>
        <td style={tableText}>{calculateActualValueChM(41,5,6)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[5]}</td>
        <td style={tableText}>{calculateActualValueCPM(41,5,6)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[4]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[4]}</td>
        <td style={tableText}>{calculateActualValue(34,4,5)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[4]}</td>
        <td style={tableText}>{calculateActualValueAWPM(34,4,5)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[4]}</td>
        <td style={tableText}>{calculateActualValueChM(34,4,5)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[4]}</td>
        <td style={tableText}>{calculateActualValueCPM(34,4,5)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[3]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[3]}</td>
        <td style={tableText}>{calculateActualValue(27,3,4)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[3]}</td>
        <td style={tableText}>{calculateActualValueAWPM(27,3,4)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[3]}</td>
        <td style={tableText}>{calculateActualValueChM(27,3,4)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[3]}</td>
        <td style={tableText}>{calculateActualValueCPM(27,3,4)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[2]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[2]}</td>
        <td style={tableText}>{calculateActualValue(20,2,3)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[2]}</td>
        <td style={tableText}>{calculateActualValueAWPM(20,2,3)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[2]}</td>
        <td style={tableText}>{calculateActualValueChM(20,2,3)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[2]}</td>
        <td style={tableText}>{calculateActualValueCPM(20,2,3)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? 'TBD' : JSON.parse(localStorage.getItem("storedGoalDate"))[1]}</th>
        <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[1]}</td>
        <td style={tableText}>{calculateActualValue(13,1,2)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[1]}</td>
        <td style={tableText}>{calculateActualValueAWPM(13,1,2)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[1]}</td>
        <td style={tableText}>{calculateActualValueChM(13,1,2)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[1]}</td>
        <td style={tableText}>{calculateActualValueCPM(13,1,2)}</td>
      </tr>
      <tr style={this.state.seenGoalTable ? {display:""}:{display:"none"}}>
      <th scope="row">{(localStorage.getItem("storedGoalDate") == null) ? getCurrentDate() : JSON.parse(localStorage.getItem("storedGoalDate"))[0]}</th>
      <td style={tableText}>{(localStorage.getItem("storedGoalWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalWPM"))[0]}</td>
        <td style={tableText}>{calculateActualValue(6,0,1)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalAWPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalAWPM"))[0]}</td>
        <td style={tableText}>{calculateActualValueAWPM(6,0,1)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalChM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalChM"))[0]}</td>
        <td style={tableText}>{calculateActualValueChM(6,0,1)}</td>
        <td style={tableText}>{(localStorage.getItem("storedGoalCPM") == null) ? "-" : JSON.parse(localStorage.getItem("storedGoalCPM"))[0]}</td>
        <td style={tableText}>{calculateActualValueCPM(6,0,1)}</td>
      </tr>

    </table>

    <button onClick={this.togglePop} className="text-white inline-block bg-[#333] hover:bg-[#3b3b3b] active:bg-[#222]" style={{borderBottomLeftRadius: "5px", borderBottomRightRadius: "5px", marginBottom:"15px"}}>View your goals</button>

      </React.Fragment>
    );
  }
}
function calculateActualValue(inDaysNumber : number, firstArrayNum : number, secondArrayNum : number){
...
function calculateActualValueChM(inDaysNumber : number, firstArrayNum : number, secondArrayNum : number){
  let firstVal = JSON?.parse(localStorage?.getItem("storedGoalDate"));
  if (firstVal != null) {
    firstVal = firstVal[0];
}
...
function calculateActualValueCPM(inDaysNumber : number, firstArrayNum : number, secondArrayNum : number){
...
function calculateActualValueAWPM(inDaysNumber : number, firstArrayNum : number, secondArrayNum : number){
...
function testFunc (inDaysNumber : number, firstArrayNum : number, secondArrayNum : number){
