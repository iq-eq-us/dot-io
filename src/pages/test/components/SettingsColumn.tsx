...
function SettingsColumn(): ReactElement {
  ...
  onClick={handleSettingsTabClick}
      ...
      className={`feather xl:ml-8 feather-settings hover:text-gray-400 text-white cursor-pointer active:text-gray-700 ${trainingSettings.isDisplayingSettingsModal == true ? 'absolute' : 'absolute'}`}
    >
