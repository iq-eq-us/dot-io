...
export const MultiRangeSlider = (props: Props, ref: React.ForwardedRef<HTMLDivElement>): JSX.Element => {
	...
	return (
		<div ref={ref} id={props.id} className={(props.baseClassName || 'multi-range-slider') + ' ' + (props.className || '')} style={props.style} onWheel={onMouseWheel}>
              ...
              <div className='text-[6px] absolute font-bold m-auto text-center text-neutral-600 flex-col'>{i*step}</div>
			...
			<div className='bar flex pointer-events-none' ref={refBar}>
				...
				<div className='thumb thumb-left pointer-events-none	' style={{ backgroundColor: props.thumbLeftColor }} onMouseDown={onLeftThumbMousedown} onTouchStart={onLeftThumbTouchStart}>
