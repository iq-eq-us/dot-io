...
function VerticalStatsTrigrams(): ReactElement {
  const x = JSON.parse(localStorage.getItem('CPM_TRIGRAM'));
  ...
  y.forEach((element) => {
    ...
    let cpm = averageCharacterPerMin.toFixed(0);
...
export default VerticalStatsTrigrams;
