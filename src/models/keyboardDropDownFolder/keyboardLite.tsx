      ...
      <div className="body" style={keyboardBodyStyle}>
        <div className="keyboard" style={keyboardStyle}>
          ...
          <div className="row" style={rowStyle}>
            ...
            <div style={compare2(2, 2) ? highlightedButtonStyle : buttonStyle}>
              Q
            </div>
            <div style={compare2(2, 3) ? highlightedButtonStyle : buttonStyle}>
              W
            </div>
            <div style={compare2(2, 4) ? highlightedButtonStyle : buttonStyle}>
              E
            </div>
            <div style={compare2(2, 5) ? highlightedButtonStyle : buttonStyle}>
              R
            </div>
            <div style={compare2(2, 6) ? highlightedButtonStyle : buttonStyle}>
              T
            </div>
            <div style={compare2(2, 7) ? highlightedButtonStyle : buttonStyle}>
              Y
            </div>
            <div style={compare2(2, 8) ? highlightedButtonStyle : buttonStyle}>
              U
            </div>
            <div style={compare2(2, 9) ? highlightedButtonStyle : buttonStyle}>
              I
            </div>
            <div style={compare2(2, 10) ? highlightedButtonStyle : buttonStyle}>
              O
            </div>
            <div style={compare2(2, 11) ? highlightedButtonStyle : buttonStyle}>
              P
            </div>
            <div style={compare2(2, 12) ? highlightedButtonStyle : buttonStyle}>
              [
            </div>
            <div style={compare2(2, 13) ? highlightedButtonStyle : buttonStyle}>
              ]
            </div>
          ...
          <div className="row" style={rowStyle}>
            ...
            <div style={compare2(3, 2) ? highlightedButtonStyle : buttonStyle}>
              A
            </div>
            <div style={compare2(3, 3) ? highlightedButtonStyle : buttonStyle}>
              S
            </div>
            <div style={compare2(3, 4) ? highlightedButtonStyle : buttonStyle}>
              D
            </div>
            <div style={compare2(3, 5) ? highlightedButtonStyle : buttonStyle}>
              F
            </div>
            <div style={compare2(3, 6) ? highlightedButtonStyle : buttonStyle}>
              G
            </div>
            <div style={compare2(3, 7) ? highlightedButtonStyle : buttonStyle}>
              H
            </div>
            <div style={compare2(3, 8) ? highlightedButtonStyle : buttonStyle}>
              J
            </div>
            <div style={compare2(3, 9) ? highlightedButtonStyle : buttonStyle}>
              K
            </div>
            <div style={compare2(3, 10) ? highlightedButtonStyle : buttonStyle}>
              L
            </div>
            <div style={compare2(3, 11) ? highlightedButtonStyle : buttonStyle}>
              ;
            </div>
            <div style={compare2(3, 12) ? highlightedButtonStyle : buttonStyle}>
              &apos;
            </div>
          ...
          <div className="row" style={rowStyle}>
            ...
            <div style={compare2(4, 2) ? highlightedButtonStyle : buttonStyle}>
              Z
            </div>
            <div style={compare2(4, 3) ? highlightedButtonStyle : buttonStyle}>
              X
            </div>
            <div style={compare2(4, 4) ? highlightedButtonStyle : buttonStyle}>
              C
            </div>
            <div style={compare2(4, 5) ? highlightedButtonStyle : buttonStyle}>
              V
            </div>
            <div style={compare2(4, 6) ? highlightedButtonStyle : buttonStyle}>
              B
            </div>
            <div style={compare2(4, 7) ? highlightedButtonStyle : buttonStyle}>
              N
            </div>
            <div style={compare2(4, 8) ? highlightedButtonStyle : buttonStyle}>
              M
            </div>
            <div style={buttonStyle}>,</div>
            <div style={buttonStyle}>.</div>
